<?php
/**
 * NZ SIM DATABASE - Premium Golden Edition
 * Powered by NAWAB ZADA HACKER
...
<head>
    ...
    <title>NZ SIM DATABASE | Premium Golden Edition</title>
...
<body class="p-3 md:p-4">
    <div class="max-w-2xl mx-auto">
        ...
        <footer class="mt-8 text-center">
            ...
            <p class="mb-2 mt-6 text-gold-primary/60 font-bold text-xs premium-font tracking-widest">POWERED BY NAWAB ZADA HACKER</p>
            <div class="flex justify-center gap-3 mb-3">
                <a href="https://whatsapp.com/channel/0029VbB47ttDDmFNztpnZf2m" target="_blank" class="bg-green-600/10 text-green-400 border border-green-600/20 px-3 py-1 rounded-full text-xs hover:bg-green-600/20 transition flex items-center gap-1" style="background-color: rgba(22, 163, 74, 0.1); color: #4ade80; border: 1px solid rgba(22, 163, 74, 0.2); padding: 4px 12px; border-radius: 9999px; font-size: 9px; display: flex; align-items: center; gap: 4px; text-decoration: none; transition: all 0.2s;">
            ...
            <p class="text-xs text-gray-600">&copy; <?php echo date('Y'); ?>NZ SIM DATABASE PREMIUM. All Rights Reserved.</p>
        </footer>
    </div>
